<x-app-layout>
  ...
  <div  class="formulaire my-3 p-3 bg-body rounded shadow-sm">
    ...
    @endif
    <div>
    <form class="form creercat" style="width:75%" method="Post" action="{{route('admin.catalogue.ajouter')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-3 col-12">
            <label for="exampleInputEmail1" class="form-label"><strong> <h4>Nom</h4></strong></label>
            <input type="text" class="form-control" name="Nom" value="{{ old('Nom') }}">
        </div>
        <div class="mb-3 col-12">
            <label for="exampleInputEmail1" class="form-label"></label>
            <textarea class="ranger" style="width: 60%;" name="Desciption" 
            value="{{ old('Desciption') }}" placeholder="Entrer votre Description" rows="10"></textarea>
        </div>
        <div class="mb-3 col-12">
        <label for="formFileSm" class="form-label"><strong><h4>choisi une image</h4></strong></label>
