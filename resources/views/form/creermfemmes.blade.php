<x-app-layout>
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    <div class="card-header">
        <h3 class="ajout text-center text-uppercase border-bottom pb-2 mb-5">Ajouter sa mesure</h3>
    </div>
    <div class="mt-4">
    ...
    <form style="width:100%" method="Post" action="{{route('mfemme.ajouter')}}" class="form align-self-center">
    <div class="row col align-self-center" style="text-align: center; ">
        @csrf
