        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('admin.catalogue')">
                            {{ __('Catalogue femme') }}
                        </x-dropdown-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown-link :href="route('admin.client')">
                    <div class="menu"> {{ __('Clients') }}</div>
                </x-dropdown-link>
            </div>

            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown-link :href="route('admin.employe')">
                    <div class="menu"> {{ __('Employes') }}</div>
                </x-dropdown-link>
            </div>

            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown-link :href="route('admin.commande')">
                    <div class="menu"> {{ __('Commande') }}</div>
                </x-dropdown-link>
            </div>

            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown-link :href="route('admin.commande.terminer')">
                    <div class="menu"> {{ __('Commande terminée') }}</div>
                </x-dropdown-link>
            </div>
