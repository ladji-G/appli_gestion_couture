<x-admin-layout>
        ...
        <div class="col-6 d-flex  ">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <br>
              <strong>
                <h1 class="badra">BaDrA Couture</h1>
              </strong> <br><br><br>
  ...
  <div class="complet text-center carton text-uppercase my-1 p-4 bg-body rounded shadow-sm">
    <marquee><strong>
        <h1 class="bienvenue border-bottom pb-0 mb-0">Bienvenue dans mon application de gestion</h1>
      </strong></marquee>
  </div>
  <div>
    <!doctype html>
    ...
    <body class="bg-body-tertiary" data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
      ...
      <div class="imagedefond">
        <strong>
          <h1 class="mb-0 centrer">Plus qu'une simple couture</h1>
        </strong>
        <p>
        <strong></strong>
        </p>
