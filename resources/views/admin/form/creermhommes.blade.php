<x-admin-layout>
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    <div class="card-header">
        <h3 class="ajout text-center text-uppercase border-bottom pb-2 mb-5">Ajout d'un nouveau client</h3>
    </div>
    <div class="mt-4">
    ...
    @endif
    <form style="width:100%"  autocomplete="off" method="Post" action="{{route('admin.mhomme.ajouter')}}" class="form align-self-center">
        ...
        @csrf
         ...
         <div  class="mb-3 col-3">
                <select name="client_id">
                    ...
                    <?php     foreach ($listeClient as $key => $UnClient) { ?>
    ...
    <script src="{{ asset('js/creermh.js')}}"></script>
    </form>
