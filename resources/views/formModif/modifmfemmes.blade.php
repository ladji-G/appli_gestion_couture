<x-app-layout>
  ...
  <div class="card-header">
        <h3 class="entete text-center text-uppercase border-bottom pb-2 mb-5">Edition de la mesure</h3>
    </div>
    ...
    @endforeach
    <form style="width:100%" class="form" method="Post" action="{{route('mfemme.update',$mfemme->id)}}" class="align-self-center">
    <div class="row  mb-4 col align-self-center" style="text-align: center;">
        @csrf
        <input type="hidden" name="_method" value="put">
        <div class="mb-3 col-3">
            <label for="exampleInputEmail1" class="form-label">Nom</label>
            <input type="text" class="form-control" name="nom" value="{{$mfemme->nom}}">
        </div>
        <div class="mb-3 col-3">
        ...
        <a href="{{route('mfemme')}}" class="btn btn-danger">Annuler</a>
        </div>
    </div>
    </form>
